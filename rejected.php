    ...
    <section class="content">
        ...
        <div class="col-xs-12">
          <div class="box">
			...
			<h3>Rejected Leave Transaction</h3>
                 </div>
            <div class="box-body">
			<table id="accountsData" class="table table-bordered table-striped" data-role="datatable" data-searching="true">
                ...
                <tr>
				  ...
				  <th></th>
					...
					$SQL_=mysql_query("SELECT * FROM  leavetbl WHERE status='rejected'  and  approval='$mid'");
				...
				<?php if($status==""){
				?>
				<a href="operation/approve.php?id=<?php echo $cid; ?>"><button type="button" class='btn btn-success btn-xs'>Approve</button></a>
