			...
			<table id="accountsData" class="table table-bordered table-striped" data-role="datatable" data-searching="true">
                ...
                <tr>
                 ...
                 <th>Purpose</th>
					...
					$SQL_=mysql_query("SELECT  * FROM  leaverequest   WHERE  approval='$mid'    ");
							...
							while($crow = mysql_fetch_array($SQL_)){
									...
									$purposetype= $crow['purposetype'];
									$bustype= $crow['bustype'];
									$date_= date_create($crow['date_']);
									$timein= $crow['timein'];
									$timeout= $crow['timeout'];
									$status= $crow['status'];
									  ?>
				 <tr>
				
                  <td><?php echo date_format($date_,"F d, Y"); ?> </td>
				 <td><?php echo $cname; ?> </td>
				 <td><?php echo $destination; ?> </td>
				  <td><?php echo $purpose."/".$purposetype; ?> </td>
				  <td style="text-transform: uppercase;">
				<?php if($status==""){
				?>
				<a href="operation/approve_pass.php?id=<?php echo $cid; ?>"><button type="button" class='btn btn-success btn-xs'>Approve</button></a>
				<a href="operation/reject_pass.php?id=<?php echo $cid; ?>"><button type="button" class='btn btn-warning btn-xs'>Reject</button></a>
