            ...
            <div class="box-body">
                ...
                <tr>
                 ...
                 <th></th>
					...
					$SQL_=mysql_query("SELECT * FROM  requirements   ");
				 ...
				 <tr >
             	 ...
             	 <td><?php echo $type; ?> </td>
				 <td><?php echo $req; ?> </td>
				  <td><a class="btn_edit_req" id="<?php echo $cid; ?>"><button href="#editModal<?php echo $cid; ?>" role="button" data-toggle="modal" type="button" class='btn btn-success btn-xs'>Edit Requirements</button></a> </td>
						...
						<div id="editModal<?php echo $cid; ?>" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
								...
								<form class="form" method="post" action="operation/update_requirements.php">
								...
								<div class="col-sm-12">
									...
									<legend><h4><?php echo $type; ?></h4></legend>
									<textarea name="req" rows=5 cols=60 ><?php echo $req; ?></textarea>
								</div>
				...
				<br/>				
				  <td><a class="btn_add_req" id="<?php echo $cid; ?>"><button href="#addModal<?php echo $cid; ?>" role="button" data-toggle="modal" type="button" class='btn btn-warning btn-xs'>Add Requirement Type</button></a> </td>
				
						<div id="addModal<?php echo $cid; ?>" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog">
								<div class="modal-content">
								<form class="form" method="post" action="operation/add_requirements.php">
								<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
								<h3>Requirements Details</h3>
								</div>
								...
								<div class="row">
									...
									<select name="type" class="form-control">
										...
										<?php
										$sql=mysql_query("SELECT * FROM   leavetype  ");
