          ...
          <div class="box">
            ...
            <div class="box-body">
				...
				function getEmpname($id){
					...
					$SQL_=mysql_query("SELECT  * FROM   traveltbl      WHERE  approval='$mid' ");
					
							while($crow = mysql_fetch_array($SQL_)){
									$cid= $crow['id'];
									$cname= getEmpname($crow['empid']);
									$designation= $crow['designation'];
									$departure_date	= date_create($crow['departure_date']);
									$return_date	= date_create($crow['return_date']);
				 ...
				 <td><?php echo date_format($departure_date,"F d, Y"); ?> </td>
				 <td><?php echo date_format($return_date,"F d, Y"); ?> </td>
				...
				<?php if($status==""){
				?>
				<a href="operation/approve_t.php?id=<?php echo $cid; ?>"><button type="button" class='btn btn-success btn-xs'>Approve</button></a>
				<a href="operation/reject_t.php?id=<?php echo $cid; ?>"><button type="button" class='btn btn-warning btn-xs'>Reject</button></a>
				...
				?>
				  ...
				  <td><a class="btn_edit_req" id="<?php echo $cid; ?>"><button href="#editModal<?php echo $cid; ?>" role="button" data-toggle="modal" type="button" class='btn btn-success btn-xs'>Edit Remarks</button></a> </td>
				 	<td><a href="operation/send_notif.php?id=<?php echo $cid; ?>"><button type="button" class='btn btn-danger btn-xs'>Send Notification</button></a></td>
				 		</tr>
							<div id="editModal<?php echo $cid; ?>" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog">
								<div class="modal-content">
								<form class="form" method="post" action="operation/update_remarks.php">
								...
								<div class="col-sm-12">
									...
									<textarea name="remarks" rows=5 cols=60 ><?php echo $remarks; ?></textarea>
								</div>
