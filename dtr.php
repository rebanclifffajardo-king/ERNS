	...
	<table id="accountsData" class="table table-bordered table-striped" data-role="datatable" data-searching="true">
                ...
                <tr>
                  ...
                  <th>Payroll ID</th>
					...
					$SQL_=mysql_query("SELECT * FROM    payroll ORDER BY date_today desc  ");
				...
				<td><?php echo $cid; ?> </td>
				<td><?php echo $payrollName; ?> </td>
             	 <td><?php echo date_format($from_,"F d, Y"); ?> </td>
				  <td><?php echo date_format($to_,"F d, Y"); ?> </td>
			
						<td>
					
						<a href="operation/delete_dtr.php?id=<?php echo $cid; ?>"><button type="button" class='btn btn-danger btn-xs'><i class='glyphicon glyphicon-remove' > </i></button></a>
						</td>
				...
				<br/>
		<?php if ($admin) { ?>	  <td><a class="btn_add_payroll" id="<?php echo $cid; ?>"><button href="#addModal<?php echo $cid; ?>" role="button" data-toggle="modal" type="button" class='btn btn-warning btn-xs'>Add Payroll</button></a> </td> <?php } ?>
				<div id="addModal<?php echo $cid; ?>" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog">
								<div class="modal-content">
								<form class="form" method="post" action="operation/add_payroll.php">
								...
								<div class="row">
									<div class="col-sm-12">
									<input type="text" class="form-control" name="payrollname" placeholder="Payroll Name">
									<br/>
									</div>
								
								<div class="col-sm-6">
								<label>From</label>
								<input type="date" class="form-control" name="from_">
								</div>
	
								<div class="col-sm-6">
								<label>To</label>
								<input type="date" class="form-control" name="to_">
								</div>
