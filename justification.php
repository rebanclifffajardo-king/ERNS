    ...
    <ul class="sidebar-menu">
         <?php if ($employee) { ?>	
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="rejected.php"><i class="fa fa-circle-o"></i> <span>Denied</span>
				<span class="pull-right-container">
  ...
  <li><a href="employee.php"> Employees Record </a></li>
		 <li><a href="activitylog.php"> Activity Log  &nbsp;
		  ...
		  <?php if ($admin) { ?> <li><a href="requirements.php"> Requirements </a></li><?php } ?>
		    <li><a href="monthly_reports.php"> Reports </a></li>
			  <li><a href="dtr_employee.php"> My DTR </a></li>
      </ul>
    </section>
          ...
          <div class="box">
			...
			<table id="accountsData" class="table table-bordered table-striped" data-role="datatable" data-searching="true">
				...
				function getEmpname($id){
					...
					if ($employee) {
						$SQL_=mysql_query("SELECT  * FROM    justification    WHERE  empid='$mid'    ORDER BY date_today desc  ");
					 
					}else{
						$SQL_=mysql_query("SELECT  * FROM    justification    WHERE  approval='$mid'    ORDER BY date_today desc  ");
							...
							while($crow = mysql_fetch_array($SQL_)){
									...
									$cname= getEmpname($crow['empid']);
									 ...
									 $date_= date_create($crow['date_']);
									 $date_=date_format($date_,"F d, Y");
									 $reason= $crow['reason'];
									 $remarks= $crow['remarks'];
									 $attachment= $crow['attachment'];
									 $details="Date: ".$date_."<br/> Reason: ".$reason."<br/> Remarks: ".$remarks."<br/> Attachment: ".$attachment;
									$date_today	= date_create($crow['date_today']);
									  ?>
				 <tr >
				
             	 <td><?php echo date_format($date_today,"F d, Y"); ?> </td>
				 <td><?php echo $cname; ?> </td>
				 <td><?php echo $details; ?> </td>
					<td style="text-transform: uppercase;">
				<?php if($status==""){
				?>
				<a href="operation/approve_justification.php?id=<?php echo $cid; ?>"><button type="button" class='btn btn-success btn-xs'>Approve</button></a>
				<a href="operation/reject_justification.php?id=<?php echo $cid; ?>"><button type="button" class='btn btn-warning btn-xs'>Deny</button></a>
				...
				?>
				   ...
				   <td><a  href="report.php?id=<?php echo $eid; ?>"><button role="button"  type="button" class='btn btn-danger btn-xs'>View DTR Report</button></a> 
				   <a  href="justify.php?id=<?php echo $eid; ?>"><button role="button"  type="button" class='btn btn-primary btn-xs'>View Justification Report</button></a> </td>
